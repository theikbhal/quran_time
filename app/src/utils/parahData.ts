...
export const parahs: Parah[] = [
  ...
  },
  {
    ...
    transliteration: "Tilka al-Rusul",
    startSurah: "Al-Baqarah",
    startAyah: 253,
    endSurah: "Al-Imran",
    endAyah: 92
  ...
  },
  {
    ...
    transliteration: "Aqtaraba Linnas",
  ...
  {
    number: 28,
    arabicName: "قَدْ سَمِعَ اللهُ",
    transliteration: "Qad Sami Allah",
...
export const getDefaultVideoLink = (parahNum: number): string => {
...
export const fullQuranVideoLink = "https://www.youtube.com/watch?v=uE1gaC29fx0";
export const fullPlaylistLink = "https://www.youtube.com/watch?list=PLIFqLbIyGu85VBS98tuaNe-UgwV7odQvc";
