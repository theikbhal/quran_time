export function toHijri(dateInput) {
  ...
  try {
    // Attempt to use native Intl.DateTimeFormat
    ...
    // Mathematical tabular Islamic calendar fallback (Kuwaiti algorithm)
...
export function getGregorianFormatted(dateInput) {
  const date = new Date(dateInput);
